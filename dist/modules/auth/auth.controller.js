...
router.patch("/send-password", (0, validation_middleware_1.validation)(validators.sendForgotCode), auth_service_1.default.sendForgotCode);
router.patch("/verify-send-password", (0, validation_middleware_1.validation)(validators.verifySendForgotCode), auth_service_1.default.verifySendForgotCode);
router.patch("/reset-forget-password", (0, validation_middleware_1.validation)(validators.resetForgotPassword), auth_service_1.default.resetForgotPassword);
