...
router.patch("/profile-image-pre", (0, authentication_middleware_1.authentication)(), user_service_1.default.preSignedUpUrl);
...
router.delete("/:userId/hard-delete-account", (0, authentication_middleware_1.authorization)(user_authorization_1.endPoint.hardDeleteAccount), (0, validation_middleware_1.validation)(validators.hardDeleteAccount), user_service_1.default.hardDeleteAccount);
